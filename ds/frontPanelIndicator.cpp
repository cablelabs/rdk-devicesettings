...
/**
 * @fn FrontPanelIndicator::Color::Color(int id)
 * @brief This function is a parameterised constructor of Color. It creates and initializes the Color
 * instance with the specified id, only if the id passed is valid.
 *
 * @param[in] id Indicates the id with with the Color instance needs to be initialized. The id
 * can be used to get the RGB value for the color.
 *
 * @return None
 */
